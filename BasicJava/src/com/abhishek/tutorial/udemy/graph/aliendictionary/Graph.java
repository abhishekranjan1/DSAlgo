package com.abhishek.tutorial.udemy.graph.aliendictionary;
...
class Graph
{
    ...
    void topologicalSort()
    {
        ...
        boolean[] visited = markAllVerticesNotVisited();
    ...
    private boolean[] markAllVerticesNotVisited() {
